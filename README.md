# Module for green hydrogen production calculation

Given a cost curve for variable renewable technologies production in energy terms, water availability, and cost assumption for electrolysers, this module helps calculate the green hydrogen production curve.
...
```shell
git clone git@github.com:tud-mchen6/module_gh2_prod.git
cd module_gh2_prod
pixi install --all
```
